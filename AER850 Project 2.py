...
# Here is how you can adjust your existing code according to these requirements. Please note, if you would like to use the `LeakyReLU` as the activation function, you should add it as a separate layer.

### CREATE 2ND MODEL wihtout hyperparatmeters 
